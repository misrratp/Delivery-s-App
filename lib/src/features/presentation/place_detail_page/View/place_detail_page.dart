  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
         label: headerText(texto: 'Añadir a la cesta 95.40', color: Colors.white, fontWeight: FontWeight.w600, fontSize: 17)),
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            actions: [
              ...
              IconButton(onPressed: (){}, icon: Icon(Icons.bookmark_border, color: Colors.white, size: 30,))
            ],
      ...
      return Column(
        children: [
          Container(
            ...
            child: headerText(texto: "Boon Lay Ho Huat Fried Prawn Noodle", color: Colors.white, fontWeight: FontWeight.bold, fontSize: 30.0),
          ), 
          Container(
            padding: EdgeInsets.symmetric(horizontal: 30.0),
            ...
            child: Row(
              children: [
                ...
                headerText(texto: "03 Jameson Manors Apt. 177", color: gris, fontWeight: FontWeight.w500, fontSize: 15.0),
              ],
            ),
          )
        ],
    ...
    children: [
      ...
      Column(
        ...
        children: [
          ...
          headerText(texto: 'Favourites', color: gris, fontWeight: FontWeight.w500, fontSize: 15.0)
        ],
      ),
      Container(
        height: 40,
      ...
      Column(
        ...
        children: [
          Row(children: [
            ...
            headerText(texto: '345', color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15.0)
          ],),
          headerText(texto: 'Photos', color: gris, fontWeight: FontWeight.w500, fontSize: 15.0)
        ],
      )
    ],
  ),
      ...
      children: [
       ClipRRect(
             ...
             Container(
              ...
              child: headerText(texto: "Penaut Chaat with Dahi",fontWeight: FontWeight.bold, fontSize: 15.0)
              ),
              Container(
              alignment: Alignment.centerLeft,
              child: headerText(texto: "9.50",fontWeight: FontWeight.w500,color: gris, fontSize: 14.0)
              ),
              Row(
                children: [
                  Container(
              margin: EdgeInsets.only(top: 10),
              child: headerText(texto: "Selecciona",fontWeight: FontWeight.w500,color: orange, fontSize: 15.0)
              ),
              Container(
...
Widget _menuItem(BuildContext context, String text, String itemCount) {
  return Container(
    ...
    child: Column(
      children: [
        ListTile(
          title: headerText(texto: text, fontWeight: FontWeight.w300, fontSize: 17.0),
