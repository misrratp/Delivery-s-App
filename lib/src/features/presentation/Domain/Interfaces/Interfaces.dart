...
abstract class SignUpRepository {
 Future<Result<SignUpDecodable, Failure>> singUp({ required SignUpRepositoryParameters params });
}

// User Database Repositories
abstract class SaveUserDataRepository{
 Future<Result<SignUpDecodable, Failure>> saveUserData({required UserBodyParameters parameters});
}